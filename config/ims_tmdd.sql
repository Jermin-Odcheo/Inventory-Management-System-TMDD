...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 14, 2025 at 02:32 AM
...
INSERT INTO `audit_log` (`TrackID`, `UserID`, `EntityID`, `Action`, `Details`, `OldVal`, `NewVal`, `Module`, `Status`, `Date_Time`) VALUES
                                                                                                                                        (19, 1, 50, 'Modified', 'Updated fields: Email, First_Name, Last_Name, Department', '{\"Email\": \"testcase3@example.com\", \"Status\": \"Online\", \"User_ID\": 50, \"Password\": \"$2y$10$0Iz.DziXOeBZq7MaVgHTZe8UmQuv0KCW5MIrKHMSH6K7QlNnKyG7u\", \"Last_Name\": \"testcase3\", \"Department\": \"testcase3\", \"First_Name\": \"testcase3\", \"is_deleted\": 0, \"Last_Active\": null}', '{\"Email\": \"testcase33@example.com\", \"Status\": \"Online\", \"User_ID\": 50, \"Password\": \"$2y$10$0Iz.DziXOeBZq7MaVgHTZe8UmQuv0KCW5MIrKHMSH6K7QlNnKyG7u\", \"Last_Name\": \"testcase33\", \"Department\": \"testcase33\", \"First_Name\": \"testcase33\", \"is_deleted\": 0, \"Last_Active\": null}', 'User Management', 'Successful', '2025-02-14 10:29:40'),
                                                                                                                                        (20, 1, 50, '', 'User soft deleted (is_deleted set to 1)', '{\"Email\": \"testcase33@example.com\", \"Status\": \"Online\", \"User_ID\": 50, \"Last_Name\": \"testcase33\", \"Department\": \"testcase33\", \"First_Name\": \"testcase33\", \"is_deleted\": 0, \"Last_Active\": null}', '{\"Email\": \"testcase33@example.com\", \"Status\": \"Online\", \"User_ID\": 50, \"Last_Name\": \"testcase33\", \"Department\": \"testcase33\", \"First_Name\": \"testcase33\", \"is_deleted\": 1, \"Last_Active\": null}', 'User Management', 'Successful', '2025-02-14 10:29:43'),
                                                                                                                                        (21, 1, 50, 'Modified', 'Updated fields: is_deleted', '{\"Email\": \"testcase33@example.com\", \"Status\": \"Online\", \"User_ID\": 50, \"Password\": \"$2y$10$0Iz.DziXOeBZq7MaVgHTZe8UmQuv0KCW5MIrKHMSH6K7QlNnKyG7u\", \"Last_Name\": \"testcase33\", \"Department\": \"testcase33\", \"First_Name\": \"testcase33\", \"is_deleted\": 0, \"Last_Active\": null}', '{\"Email\": \"testcase33@example.com\", \"Status\": \"Online\", \"User_ID\": 50, \"Password\": \"$2y$10$0Iz.DziXOeBZq7MaVgHTZe8UmQuv0KCW5MIrKHMSH6K7QlNnKyG7u\", \"Last_Name\": \"testcase33\", \"Department\": \"testcase33\", \"First_Name\": \"testcase33\", \"is_deleted\": 1, \"Last_Active\": null}', 'User Management', 'Successful', '2025-02-14 10:29:43');
...
INSERT INTO `users` (`User_ID`, `Email`, `Password`, `First_Name`, `Last_Name`, `Department`, `Status`, `last_active`, `is_deleted`) VALUES
                                                                                                                                         ...
                                                                                                                                         (2, 'administrator@example.com', '$2y$10$Pf0uRneLsEex.szkU8vJS.P27ttwz9EtZkND8w4ttadglX6AVQFpe', 'Admin', 'Inistrator', 'Department', '', NULL, 0),
                                                                                                                                         (47, 'asd@gmail.com', '$2y$10$zLA7Vv1sJTkThf3fqOtJ/umJHR.uLy8IaFRVdGamZA0ogP.qR.Fsy', 'asd', 'asd', 'asd', 'Online', NULL, 1),
                                                                                                                                         (49, 'test@example.com', '$2y$10$qnaGKeej4oj.gJYJ.HblaeOlE9JmXLZOFzifR2RARgONLLhzLKYOW', 'test', 'test', '', 'Online', NULL, 1),
                                                                                                                                         (50, 'testcase33@example.com', '$2y$10$0Iz.DziXOeBZq7MaVgHTZe8UmQuv0KCW5MIrKHMSH6K7QlNnKyG7u', 'testcase33', 'testcase33', 'testcase33', 'Online', NULL, 1);
...
CREATE TRIGGER `users_after_update` AFTER UPDATE ON `users` FOR EACH ROW BEGIN
    ...
    -- Check which fields were modified and add them to diffList
    ...
    IF OLD.Password <> NEW.Password THEN SET diffList = CONCAT(diffList, 'Password, '); END IF;
