                                ...
                                <?php if ($user['is_deleted']): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-success restore-individual" data-id="<?php echo $user['User_ID']; ?>">
                                                Restore
                                            </button>
...
<script>
    $(document).ready(function() {
        // Enable/disable the action buttons based on checkboxes
        ...
        // Handler for "Delete Selected" button (for active users)
        ...
        // Handler for "Restore Selected" button (for deleted users)
        ...
        // Handler for individual deletion: bind only to buttons that have a data-id attribute.
        ...
        // Handler for individual restore: direct restore (no modal)
