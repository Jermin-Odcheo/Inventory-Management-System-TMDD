...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'add') {
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO departments (id, abbreviation, department_name) VALUES (?, ?, ?)");
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#addDepartmentForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    showToast('Error submitting form: ' + error, 'error', 5000);
                }
            });
        });
        ...
        $('#editDepartmentForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    showToast('Error updating department: ' + error, 'error', 5000);
                }
            });
        });
        ...
        // Fetch the latest department ID for the Add Department form
