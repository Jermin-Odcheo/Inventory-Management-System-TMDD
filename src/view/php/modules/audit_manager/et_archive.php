...
<script>
    ...
    $(document).on('click', '#confirmRestoreBtn', function () {
        if (restoreId && restoreModule) {
            var restoreUrl = '';
            var redirectUrl = '';
            var data = { id: restoreId };
            if (restoreModule === 'Purchase Order') {
                restoreUrl = '../../modules/equipment_manager/restore_purchase_order.php';
                redirectUrl = '../../modules/equipment_manager/purchase_order.php';
            } else if (restoreModule === 'Charge Invoice') {
                restoreUrl = '../../modules/equipment_manager/restore_charge_invoice.php';
                redirectUrl = '../../modules/equipment_manager/charge_invoice.php';
            } else if (restoreModule === 'Receiving Report') {
                restoreUrl = '../../modules/equipment_manager/restore_receiving_report.php';
                redirectUrl = '../../modules/equipment_manager/receiving_report.php';
            } else {
    ...
    $(document).on('click', '#confirmBulkRestoreBtn', function () {
        if (bulkRestoreIds.length > 0) {
            $.ajax({
                url: '../../modules/equipment_manager/restore_purchase_order.php',
                method: 'POST',
