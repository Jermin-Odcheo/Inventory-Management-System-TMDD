...
<body>
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row">
                <!-- Main Content -->
                <main class="col-md-12 px-4 py-3" style="margin-left: 300px; max-width: calc(100% - 320px);">
                    ...
                    <div class="card mb-4 shadow-sm" style="max-width: 1200px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="equipmentDetailsID" name="equipmentDetailsID" required>
                                        </div>
                    ...
                    <div class="card shadow-sm" style="max-width: 1200px;">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover align-middle table-sm" id="equipmentTable">
